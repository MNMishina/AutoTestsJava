/**
 * Наследует класс BaseSelenideTest. Получает атрибуты кандидата (конкретное резюме) на сайте hh.ru через HashMap,
 *
 * сравнивает актуальный и ожидаемый результат
 */
