...
*/
    //public String getCity() {
        //return city.getText();
    //}
                    //replaceAll регулярное выражение \D+ находит все буквы и символы (кроме цифр) в тексте (26 лет) и заменяет их на пустое значение.
                    // в результате остаются цифры 26, что нам и нужно
                    // return Integer.parseInt() преобразование текста в число-возвращаем число из строки
    //public int getAge(){
        //return Integer.parseInt(age.getText().replaceAll("\\D+", ""));
    //}
    //                              Метод для новичков:
    // получение текста из вебэлемента (пол М или Ж)
